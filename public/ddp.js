/* MeteorDdp - a client for DDP version pre1 (modified to support pre2 heartbeats) */

var MeteorDdp = function(wsUri) {
  this.VERSIONS = ["pre2", "pre1"];
...
MeteorDdp.prototype._respondToPing = function (data) {
  data.msg = 'pong';
  this.send(data);
};
